...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Caratus", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Caratus</b> version", 0));
...
"Copyright \302\251 2017 The Caratus Developers", 0));
