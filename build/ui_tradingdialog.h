...
public:
    ...
    QLabel *label_17;
    QPushButton *BuyCARAT;
    QPushButton *SellCARATBTN;
    ...
    QLabel *label_11;
    QLabel *CARATBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *CARATAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *CARATPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        CARATAvailableLabel = new QLabel(BuyTab);
        CARATAvailableLabel->setObjectName(QStringLiteral("CARATAvailableLabel"));
        QPalette palette1;
        ...
        CARATAvailableLabel->setPalette(palette1);
        CARATAvailableLabel->setFont(font3);
        CARATAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(CARATAvailableLabel);

        labelCARAT = new QLabel(BuyTab);
        labelCARAT->setObjectName(QStringLiteral("labelCARAT"));
        labelCARAT->setFont(font3);

        horizontalLayout->addWidget(labelCARAT);
        ...
        UnitsInputCARAT = new QLineEdit(BuyTab);
        UnitsInputCARAT->setObjectName(QStringLiteral("UnitsInputCARAT"));
        UnitsInputCARAT->setMinimumSize(QSize(0, 0));
        UnitsInputCARAT->setFont(font5);

        gridLayout_6->addWidget(UnitsInputCARAT, 4, 9, 1, 1);
        ...
        BuyCARAT = new QPushButton(BuyTab);
        BuyCARAT->setObjectName(QStringLiteral("BuyCARAT"));

        gridLayout_6->addWidget(BuyCARAT, 7, 3, 1, 1);

        SellCARATBTN = new QPushButton(BuyTab);
        SellCARATBTN->setObjectName(QStringLiteral("SellCARATBTN"));

        gridLayout_6->addWidget(SellCARATBTN, 7, 9, 1, 1);
        ...
        CARATDemand = new QLabel(BuyTab);
        CARATDemand->setObjectName(QStringLiteral("CARATDemand"));
        QFont font6;
        font6.setPointSize(8);
        CARATDemand->setFont(font6);
        CARATDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(CARATDemand, 0, 1, 1, 5);

        CARATSupply = new QLabel(BuyTab);
        CARATSupply->setObjectName(QStringLiteral("CARATSupply"));
        CARATSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(CARATSupply, 0, 9, 1, 3);
        ...
        BittrexCARATLabel = new QLabel(tab);
        BittrexCARATLabel->setObjectName(QStringLiteral("BittrexCARATLabel"));
        QPalette palette7;
        ...
        BittrexCARATLabel->setPalette(palette7);
        BittrexCARATLabel->setFont(font7);
        BittrexCARATLabel->setAutoFillBackground(false);
        BittrexCARATLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexCARATLabel);
        ...
        CARATBalanceLabel = new QLabel(BalanceTab);
        CARATBalanceLabel->setObjectName(QStringLiteral("CARATBalanceLabel"));
        CARATBalanceLabel->setFont(font4);
        CARATBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(CARATBalanceLabel, 0, 3, 1, 1);
        ...
        CARATAvailableLabel_2 = new QLabel(BalanceTab);
        CARATAvailableLabel_2->setObjectName(QStringLiteral("CARATAvailableLabel_2"));
        CARATAvailableLabel_2->setFont(font4);
        CARATAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(CARATAvailableLabel_2, 1, 3, 1, 1);
        ...
        CARATPendingLabel = new QLabel(BalanceTab);
        CARATPendingLabel->setObjectName(QStringLiteral("CARATPendingLabel"));
        CARATPendingLabel->setFont(font4);
        CARATPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(CARATPendingLabel, 2, 3, 1, 1);
        ...
        CARATBalanceLabel->raise();
        CARATAvailableLabel_2->raise();
        CARATPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "CARAT Available:", 0));
        CARATAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelCARAT->setText(QApplication::translate("tradingDialog", " CARAT", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "CARAT", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "CARAT", 0));
        ...
        BuyCARAT->setText(QApplication::translate("tradingDialog", "Buy CARAT", 0));
        SellCARATBTN->setText(QApplication::translate("tradingDialog", "Sell CARAT", 0));
        ...
        CARATDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 CARAT", 0));
        CARATSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 CARAT", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in CARAT:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "CARAT", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "CARAT Balance:", 0));
        BittrexCARATLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "CARAT", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "CARAT Balance:", 0));
        CARATBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "CARAT Available:", 0));
        CARATAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "CARAT Pending:", 0));
        CARATPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate CARAT Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw CARAT:", 0));
