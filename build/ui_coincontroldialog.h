...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 CARAT"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 CARAT"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 CARAT"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 CARAT"));
