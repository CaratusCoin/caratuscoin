...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Caratus - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Caratus Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Caratus debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Caratus-Qt help message to get a list with possible Caratus command-line options.", 0));
#endif // QT_NO_TOOLTIP
