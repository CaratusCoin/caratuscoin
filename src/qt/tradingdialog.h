...
private slots:
    ...
    QString BuyCARAT(QString OrderType, double Quantity, double Rate);
    QString SellCARAT(QString OrderType, double Quantity, double Rate);
