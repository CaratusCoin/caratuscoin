...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeCaratusAmount"))
        settings.setValue("nAnonymizeCaratusAmount", 1000);
    nAnonymizeCaratusAmount = settings.value("nAnonymizeCaratusAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeCaratusAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeCaratusAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeCaratusAmount:
            return QVariant(nAnonymizeCaratusAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeCaratusAmount:
            nAnonymizeCaratusAmount = value.toInt();
            settings.setValue("nAnonymizeCaratusAmount", nAnonymizeCaratusAmount);
            emit AnonymizeCaratusAmountChanged(nAnonymizeCaratusAmount);
            break;
        default:
            break;
        }
