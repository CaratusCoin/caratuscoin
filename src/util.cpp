...
int nAnonymizeCaratusAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Caratus
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Caratus
    // Mac: ~/Library/Application Support/Caratus
    // Unix: ~/.Caratus
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Caratus";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Caratus.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Caratusd.pid"));
