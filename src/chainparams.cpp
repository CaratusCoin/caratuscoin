...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Caratus starts 14 Feb 2018";
        ...
        assert(hashGenesisBlock == uint256("0x000099c67896668fa7113d5be468d0f034ef355303b668c559ed4afb3b8ecf63"));
        assert(genesis.hashMerkleRoot == uint256("0x0eace017d3dce1b56ad65a192b34cee3dbdff468f7ff74a438054e057a6895bb"));
        ...
        vSeeds.push_back(CDNSSeedData("0",  "45.77.99.211"));
        vSeeds.push_back(CDNSSeedData("1",  "207.148.10.196"));
        vSeeds.push_back(CDNSSeedData("2",  "45.32.207.163"));
        vSeeds.push_back(CDNSSeedData("3",  "45.76.238.244"));
        vSeeds.push_back(CDNSSeedData("4",  "45.76.246.152"));
